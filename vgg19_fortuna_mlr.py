...
from tensorflow.keras.layers import Dense, Conv2D, MaxPool2D, Flatten, SeparableConv2D, BatchNormalization
...
model.add(Conv2D(filters=512, kernel_size=(1, 3), padding="same", activation="relu"))
...
# Callbacks
checkpoint = ModelCheckpoint("vgg19tuna_mlr.keras", monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
saved_model = load_model("vgg19tuna_mlr.keras")
